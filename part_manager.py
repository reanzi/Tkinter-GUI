...
def select_item(event):
    try:
        ...
        # print(selected_item)
        # populate into the fields with the selected values
        part_entry.delete(0, END) # Delete field's data
...
# Parts List (Listbox widgit)
parts_list = Listbox(app, height=8, width=60, border=2)
